                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Center(child: Text('بحث', style: TextStyle(color: Colors.white,fontSize: 18,fontWeight: FontWeight.w600),)),
                      ),
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          decoration: InputDecoration(
                            ...
                            suffixIcon:  Icon(Icons.search,color:ColorApp.primarycolor )
                          ),
                          validator: (value) {
                  ...
                  Expanded(
                    child: ListView.builder(itemBuilder: (context, index) {
                      return TeacherWedget(teachermodel:teachermodellist[index] ,);
                    },
                      itemCount: teachermodellist.length,
                    ),
                  ),
                ],
              ),
